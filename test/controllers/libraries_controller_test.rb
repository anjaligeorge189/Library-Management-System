...
class LibrariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create library" do
    assert_difference('Library.count') do
      post libraries_url, params: { library: { author: @library.author, book_name: @library.book_name, price: @library.price } }
    end
  ...
  test "should update library" do
    patch library_url(@library), params: { library: { author: @library.author, book_name: @library.book_name, price: @library.price } }
